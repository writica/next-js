              ...
              <Card className="mb-4 bg-black/20 border-gray-800/20">
                ...
                <CardContent className="grid grid-cols-2 gap-3 text-sm">
                  <div>
                    ...
                    <p className="font-medium text-white">{scoreData.quality_score || 0}/100</p>
                  </div>
                  <div>
                    <p className="text-gray-400">Virality</p>
                    <p className="font-medium text-white">{scoreData.virality_score || 0}/100</p>
                  </div>
                  <div>
                    <p className="text-gray-400">Campaign Fit</p>
                    <p className="font-medium text-white">{scoreData.campaign_fit_score || 0}/100</p>
                  </div>
                  <div>
                    <p className="text-gray-400">Total Score</p>
                    <p className="font-medium text-emerald-400">{selectedSubmission.total_score || 0}/100</p>
                  </div>
                </CardContent>
              </Card>
            )}
              ...
              <Card className="mb-4 bg-black/20 border-gray-800/20">
                ...
                <CardContent className="text-sm">
                  <div className="mb-2">
                    ...
                    <p className="font-medium text-white">{aiContent.score || 0}/100</p>
                  </div>
                  <div>
                    <p className="text-gray-400">Analysis</p>
                    <p className="text-gray-200">{aiContent.explanation || "No explanation available"}</p>
                  </div>
                </CardContent>
              </Card>
            )}
